...
public class InvalidOperationException : System.InvalidOperationException
{
  ...
  /// </summary>
  /// <remarks>The <paramref name="value"/> parameter is checked for nullability and marked as not null if the function succeeds.</remarks>
  ...
  public static void ThrowIfNull<TValue>([NotNull] TValue? value, string? message = null) where TValue : class
  {
    if (value is null)
    {
